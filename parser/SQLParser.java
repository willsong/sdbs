...
/** Root production. */
  ...
  final public void CreateFieldDefinition(CreateStatement stmt) throws ParseException {
  Token t;
...
/* === SHARED === */
  ...
  final public FieldDefinition FieldReference() throws ParseException {
  Token t;
  FieldDefinition field = new FieldDefinition();
    if (jj_2_1(2)) {
      t = jj_consume_token(ALPHANUMERIC);
                       field.setTable(t.image);
    ...
    {if (true) return field;}
      ...
      case ALPHANUMERIC:
        t = jj_consume_token(ALPHANUMERIC);
                         field.setName(t.image); {if (true) return field;}
        break;
      case STAR:
        t = jj_consume_token(STAR);
                 field.setName(t.image); {if (true) return field;}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1001,0x1fc1,0x280000,0x500000,0x40000000,0x3800000,0x40000000,0x20000000,0x4000,0x20000000,0x4000,0x40000000,0x40000000,0x40000,0x8000000,0x80000000,0x28000000,0x8000000,0x8000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0,0x0,0xc0,0x0,0x0,0x0,0x0,0x110,0xf,0x1c0,0x100,0x100,};
   }
